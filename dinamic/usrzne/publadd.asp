...
if (String(Request("MM_insert")) != "undefined") {
  ...
  var MM_editRedirectUrl = "publaddok.asp";
  var MM_fieldsStr = "integID|value|tipoPublicID|value|tituloPublic|value|datosPublic|value|yearPublic|value";
  var MM_columnsStr = "integID|none,none,NULL|tipoPublicID|none,none,NULL|tituloPublic|',none,''|datosPublic|',none,''|yearPublic|none,none,NULL";
...
%>
<%
var rsAldea21PublAddPublTip = Server.CreateObject("ADODB.Recordset");
rsAldea21PublAddPublTip.ActiveConnection = MM_connaldea21_STRING;
rsAldea21PublAddPublTip.Source = "SELECT * FROM publicTipo ORDER BY tipoPublicID ASC";
rsAldea21PublAddPublTip.CursorType = 0;
rsAldea21PublAddPublTip.CursorLocation = 2;
rsAldea21PublAddPublTip.LockType = 3;
rsAldea21PublAddPublTip.Open();
var rsAldea21PublAddPublTip_numRows = 0;
%>
<html>
  ...
  <tr> 
    <td valign="top"><!-- #BeginEditable "contenido" --> 
      <table width="650" border="0" cellspacing="4" cellpadding="2">
        <tr> 
          <td> 
            <p><font face="Verdana, Arial, Helvetica, sans-serif" size="2"><b>INGRESAR 
              PUBLICACI&Oacute;N - 1 de 2</b></font></p>
            <form method="POST" action="<%=MM_editAction%>" name="form1">
              <table align="center">
                <tr valign="baseline"> 
                  <td nowrap align="right" bgcolor="#FFCC99"> 
                    <div align="left"><i><b><font face="Verdana, Arial, Helvetica, sans-serif" size="1">Tipo 
                      de Publicaci&oacute;n:</font></b></i></div>
                  </td>
                  <td> <font face="Verdana, Arial, Helvetica, sans-serif" size="2"> 
                    <select name="tipoPublicID">
                      <% 
while (!rsAldea21PublAddPublTip.EOF) {
%>
                      <option value="<%=(rsAldea21PublAddPublTip.Fields.Item("tipoPublicID").Value)%>"><%=(rsAldea21PublAddPublTip.Fields.Item("tipoPublic").Value)%></option>
                      <%
  rsAldea21PublAddPublTip.MoveNext();
}
if (rsAldea21PublAddPublTip.CursorType > 0) {
  if (!rsAldea21PublAddPublTip.BOF) rsAldea21PublAddPublTip.MoveFirst();
} else {
  rsAldea21PublAddPublTip.Requery();
}
%>
                    </select>
                    <input type="hidden" name="integID" value="<%= Request.Cookies ("cLogin") %>">
                    </font></td>
                </tr>
                <tr valign="baseline"> 
                  <td nowrap align="right" bgcolor="#FFCC99"> 
                    <div align="left"><i><b><font face="Verdana, Arial, Helvetica, sans-serif" size="1">T&iacute;tulo 
                      de la Publicaci&oacute;n:</font></b></i></div>
                  </td>
                  <td> <font face="Verdana, Arial, Helvetica, sans-serif" size="2"> 
                    <textarea name="tituloPublic" cols="100" rows="2"></textarea>
                    </font></td>
                </tr>
                <tr valign="baseline"> 
                  <td nowrap align="right" bgcolor="#FFCC99"> 
                    <div align="left"><i><b><font face="Verdana, Arial, Helvetica, sans-serif" size="1">Datos 
                      de la Publicaci&oacute;n:</font></b></i></div>
                  </td>
                  <td> <font face="Verdana, Arial, Helvetica, sans-serif" size="2"> 
                    <textarea name="datosPublic" cols="100" rows="4"></textarea>
                    </font></td>
                </tr>
                <tr valign="baseline"> 
                  <td nowrap align="right" bgcolor="#FFCC99"> 
                    <div align="left"><i><b><font face="Verdana, Arial, Helvetica, sans-serif" size="1">A&ntilde;o 
                      de la Publicaci&oacute;n:</font></b></i></div>
                  </td>
                  <td> <font face="Verdana, Arial, Helvetica, sans-serif" size="2"> 
                    <input type="text" name="yearPublic" value="" size="32">
                    </font></td>
                </tr>
                <tr valign="baseline"> 
                  <td nowrap align="right" colspan="2"> 
                    <div align="center"><font face="Verdana, Arial, Helvetica, sans-serif" size="2"></font> 
                      ...
                      <input type="submit" value="Agregar Registro" name="submit">
                      </font></div>
                  </td>
                </tr>
              </table>
