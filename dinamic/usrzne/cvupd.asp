...
if (String(Request("MM_update")) != "undefined" &&
  ...
  var MM_editConnection = MM_connaldea21_STRING;
  var MM_editTable  = "dataCv";
  var MM_editColumn = "cvID";
  var MM_recordId = "" + Request.Form("MM_recordId") + "";
  var MM_editRedirectUrl = "cvupdok.asp";
  ...
  var MM_columnsStr = "emailCv|',none,''|datosPersCv|',none,''|posicActCv|',none,''|lineaInvSubCv|',none,''|activDocCv|',none,''|formRHCv|',none,''|publicRelevCv|',none,''|transCv|',none,''";
...
%>
<%
var rsAldea21CvAct__MMColParam = "1";
if(String(Request.Cookies("cLogin")) != "undefined") { 
  rsAldea21CvAct__MMColParam = String(Request.Cookies("cLogin"));
}
%>
<%
var rsAldea21CvAct = Server.CreateObject("ADODB.Recordset");
rsAldea21CvAct.ActiveConnection = MM_connaldea21_STRING;
rsAldea21CvAct.Source = "SELECT cvID, emailCv, datosPersCv, posicActCv, lineaInvSubCv, activDocCv, formRHCv, publicRelevCv, transCv, integName  FROM dataCv, integ  WHERE dataCv.integID = "+ rsAldea21CvAct__MMColParam.replace(/'/g, "''") + " AND dataCv.integID = integ.integID";
rsAldea21CvAct.CursorType = 0;
rsAldea21CvAct.CursorLocation = 2;
rsAldea21CvAct.LockType = 3;
rsAldea21CvAct.Open();
var rsAldea21CvAct_numRows = 0;
%>
<html>
<!-- #BeginTemplate "/Templates/model.dwt" --> 
<head>
<!-- #BeginEditable "doctitle" --> 
<title>PPI Aldea 21 - Actualizaci&oacute;n de CV - 1 de 2</title>
<!-- #EndEditable --> 
  ...
  <tr> 
    <td valign="top"><!-- #BeginEditable "contenido" --> 
      <table width="650" border="0" cellspacing="4" cellpadding="2">
        <tr> 
          <td> 
            <p><font face="Verdana, Arial, Helvetica, sans-serif" size="2"><b>ACTUALIZACI&Oacute;N 
              DE CV - 1 de 2</b></font></p>
            <form name="form1" method="POST" action="<%=MM_editAction%>">
              <p align="center"><b><font face="Verdana, Arial, Helvetica, sans-serif" size="2"><%=(rsAldea21CvAct.Fields.Item("integName").Value)%></font></b></p>
              <table width="100%" border="1">
                <tr> 
                  <td bgcolor="#FFCC99"><font face="Verdana, Arial, Helvetica, sans-serif" size="2">email:</font></td>
                  <td> <font face="Verdana, Arial, Helvetica, sans-serif" size="2"> 
                    <input type="text" name="textfield" size="30" value="<%=(rsAldea21CvAct.Fields.Item("emailCv").Value)%>">
                    </font></td>
                </tr>
                <tr> 
                  <td bgcolor="#FFCC99"><font face="Verdana, Arial, Helvetica, sans-serif" size="2">Datos 
                    personales y formaci&oacute;n:</font></td>
                  <td> <font face="Verdana, Arial, Helvetica, sans-serif" size="2"> 
                    <textarea name="textfield2" cols="100" rows="4"><%=(rsAldea21CvAct.Fields.Item("datosPersCv").Value)%></textarea>
                    </font></td>
                </tr>
                <tr> 
                  <td bgcolor="#FFCC99"><font face="Verdana, Arial, Helvetica, sans-serif" size="2">Posici&oacute;n 
                    actual:</font></td>
                  <td> <font face="Verdana, Arial, Helvetica, sans-serif" size="2"> 
                    <textarea name="textfield3" cols="100" rows="4"><%=(rsAldea21CvAct.Fields.Item("posicActCv").Value)%></textarea>
                    </font></td>
                </tr>
                <tr> 
                  <td bgcolor="#FFCC99"><font face="Verdana, Arial, Helvetica, sans-serif" size="2">L&iacute;nea 
                    de investigaci&oacute;n, subsidios:</font></td>
                  <td> <font face="Verdana, Arial, Helvetica, sans-serif" size="2"> 
                    <textarea name="textfield4" cols="100" rows="4"><%=(rsAldea21CvAct.Fields.Item("lineaInvSubCv").Value)%></textarea>
                    </font></td>
                </tr>
                <tr> 
                  <td bgcolor="#FFCC99"><font face="Verdana, Arial, Helvetica, sans-serif" size="2">Actividad 
                    docente, conferencias, cooperaci&oacute;n, redes cient&iacute;ficas:</font></td>
                  <td> <font face="Verdana, Arial, Helvetica, sans-serif" size="2"> 
                    <textarea name="textfield5" cols="100" rows="4"><%=(rsAldea21CvAct.Fields.Item("activDocCv").Value)%></textarea>
                    </font></td>
                </tr>
                <tr> 
                  <td bgcolor="#FFCC99"><font face="Verdana, Arial, Helvetica, sans-serif" size="2">Formaci&oacute;n 
                    de recursos humanos:</font></td>
                  <td> <font face="Verdana, Arial, Helvetica, sans-serif" size="2"> 
                    <textarea name="textfield6" cols="100" rows="4"><%=(rsAldea21CvAct.Fields.Item("formRHCv").Value)%></textarea>
                    </font></td>
                </tr>
                <tr> 
                  <td bgcolor="#FFCC99"><font face="Verdana, Arial, Helvetica, sans-serif" size="2">&Uacute;ltimas 
                    publicaciones relevantes:</font></td>
                  <td> <font face="Verdana, Arial, Helvetica, sans-serif" size="2"> 
                    <textarea name="textfield7" cols="100" rows="4"><%=(rsAldea21CvAct.Fields.Item("publicRelevCv").Value)%></textarea>
                    </font></td>
                </tr>
                <tr> 
                  <td bgcolor="#FFCC99"><font face="Verdana, Arial, Helvetica, sans-serif" size="2">Transferencia: 
                    desarrollo tecnol&oacute;gico, servicios y consultor&iacute;as 
                    recientes:</font></td>
                  <td> <font face="Verdana, Arial, Helvetica, sans-serif" size="2"> 
                    <textarea name="textfield8" cols="100" rows="4"><%=(rsAldea21CvAct.Fields.Item("transCv").Value)%></textarea>
                    </font></td>
                </tr>
                <tr> 
                  <td colspan="2"> 
                    <div align="center"><font face="Verdana, Arial, Helvetica, sans-serif" size="2"></font> 
                      ...
                      <input type="submit" name="Submit" value="Actualizar CV">
                      </font></div>
                  </td>
                </tr>
              </table>
              ...
              <input type="hidden" name="MM_recordId" value="<%= rsAldea21CvAct.Fields.Item("cvID").Value %>">
            </form>
            <p></p>
          </td>
        </tr>
