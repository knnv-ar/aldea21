...
<%
var rsAldea21PublAct1__MMColParam = "1";
if(String(Request.Cookies("cLogin")) != "undefined") { 
  rsAldea21PublAct1__MMColParam = String(Request.Cookies("cLogin"));
}
%>
<%
var rsAldea21PublAct1 = Server.CreateObject("ADODB.Recordset");
rsAldea21PublAct1.ActiveConnection = MM_connaldea21_STRING;
rsAldea21PublAct1.Source = "SELECT yearPublic, integName, tituloPublic, datosPublic, tipoPublic, datosID  FROM public, integ, publicTipo  WHERE public.integID = "+ rsAldea21PublAct1__MMColParam.replace(/'/g, "''") + " AND public.tipoPublicID = publicTipo.tipoPublicID AND integ.integID = public.integID  ORDER BY yearPublic DESC";
rsAldea21PublAct1.CursorType = 0;
rsAldea21PublAct1.CursorLocation = 2;
rsAldea21PublAct1.LockType = 3;
rsAldea21PublAct1.Open();
var rsAldea21PublAct1_numRows = 0;
%>
<%
var Repeat1__numRows = -1;
var Repeat1__index = 0;
rsAldea21PublAct1_numRows += Repeat1__numRows;
%>
<%
// *** Recordset Stats, Move To Record, and Go To Record: declare stats variables

// set the record count
var rsAldea21PublAct1_total = rsAldea21PublAct1.RecordCount;

// set the number of rows displayed on this page
if (rsAldea21PublAct1_numRows < 0) {            // if repeat region set to all records
  rsAldea21PublAct1_numRows = rsAldea21PublAct1_total;
} else if (rsAldea21PublAct1_numRows == 0) {    // if no repeat regions
  rsAldea21PublAct1_numRows = 1;
}

// set the first and last displayed record
var rsAldea21PublAct1_first = 1;
var rsAldea21PublAct1_last  = rsAldea21PublAct1_first + rsAldea21PublAct1_numRows - 1;

// if we have the correct record count, check the other stats
if (rsAldea21PublAct1_total != -1) {
  rsAldea21PublAct1_numRows = Math.min(rsAldea21PublAct1_numRows, rsAldea21PublAct1_total);
  rsAldea21PublAct1_first   = Math.min(rsAldea21PublAct1_first, rsAldea21PublAct1_total);
  rsAldea21PublAct1_last    = Math.min(rsAldea21PublAct1_last, rsAldea21PublAct1_total);
}
%>
<%
...
if (rsAldea21PublAct1_total == -1) {
  ...
  for (rsAldea21PublAct1_total=0; !rsAldea21PublAct1.EOF; rsAldea21PublAct1.MoveNext()) {
    rsAldea21PublAct1_total++;
  }

  // reset the cursor to the beginning
  if (rsAldea21PublAct1.CursorType > 0) {
    if (!rsAldea21PublAct1.BOF) rsAldea21PublAct1.MoveFirst();
  } else {
    rsAldea21PublAct1.Requery();
  }

  // set the number of rows displayed on this page
  if (rsAldea21PublAct1_numRows < 0 || rsAldea21PublAct1_numRows > rsAldea21PublAct1_total) {
    rsAldea21PublAct1_numRows = rsAldea21PublAct1_total;
  }

  // set the first and last displayed record
  rsAldea21PublAct1_last  = Math.min(rsAldea21PublAct1_first + rsAldea21PublAct1_numRows - 1, rsAldea21PublAct1_total);
  rsAldea21PublAct1_first = Math.min(rsAldea21PublAct1_first, rsAldea21PublAct1_total);
}
%>
<% var MM_paramName = ""; %>
...
<title>PPI Aldea 21 - Actualizar publicaci&oacute;n - 1 de 3</title>
<!-- #EndEditable --> 
  ...
  <tr> 
    <td valign="top"><!-- #BeginEditable "contenido" --> 
      <table width="650" border="0" cellspacing="4" cellpadding="2">
        <tr> 
          <td> 
            <p><font face="Verdana, Arial, Helvetica, sans-serif" size="2"><b>ACTUALIZAR 
              PUBLICACI&Oacute;N - 1 de 3</b></font></p>
            <p><font face="Verdana, Arial, Helvetica, sans-serif" size="2"><i>Seleccione 
              la publicaci&oacute;n que quiere actualizar</i></font></p>
            <p><font face="Verdana, Arial, Helvetica, sans-serif" size="2">Total 
              de Publicaciones: <b><%=(rsAldea21PublAct1_total)%></b> </font></p>
            <table width="100%" border="1">
              <tr bgcolor="#FFCC99"> 
                ...
                <td> 
                  <div align="center"><i><b><font face="Verdana, Arial, Helvetica, sans-serif" size="1">Autor</font></b></i></div>
                </td>
                <td> 
                  <div align="center"><i><b><font face="Verdana, Arial, Helvetica, sans-serif" size="1">Tipo 
                    de publicaci&oacute;n</font></b></i></div>
                </td>
                <td> 
                  <div align="center"><i><b><font face="Verdana, Arial, Helvetica, sans-serif" size="1">T&iacute;tulo</font></b></i></div>
                </td>
                <td> 
                  <div align="center"><i><b><font face="Verdana, Arial, Helvetica, sans-serif" size="1">Datos</font></b></i></div>
                </td>
                <td> 
                  <div align="center"><i><b><font face="Verdana, Arial, Helvetica, sans-serif" size="1">Disponibilidad 
                    en l&iacute;nea</font></b></i></div>
                </td>
              </tr>
              <% while ((Repeat1__numRows-- != 0) && (!rsAldea21PublAct1.EOF)) { %>
              <tr> 
                <td><font face="Verdana, Arial, Helvetica, sans-serif" size="2"><%=(rsAldea21PublAct1.Fields.Item("yearPublic").Value)%></font></td>
                <td><font face="Verdana, Arial, Helvetica, sans-serif" size="2"><%=(rsAldea21PublAct1.Fields.Item("integName").Value)%></font></td>
                <td><font face="Verdana, Arial, Helvetica, sans-serif" size="2"><%=(rsAldea21PublAct1.Fields.Item("tipoPublic").Value)%></font></td>
                <td><font face="Verdana, Arial, Helvetica, sans-serif" size="2"><b><a href="publupd2.asp?<%= MM_keepNone + ((MM_keepNone!="")?"&":"") + "datosID=" + rsAldea21PublAct1.Fields.Item("datosID").Value %>"><%=(rsAldea21PublAct1.Fields.Item("tituloPublic").Value)%></a></b></font></td>
                <td><font face="Verdana, Arial, Helvetica, sans-serif" size="2"><%=(rsAldea21PublAct1.Fields.Item("datosPublic").Value)%></font></td>
                <td><font face="Verdana, Arial, Helvetica, sans-serif" size="2"></font></td>
              </tr>
              <%
  Repeat1__index++;
  rsAldea21PublAct1.MoveNext();
}
%>
            </table>
          </td>
