...
if (String(Request("MM_delete")) != "undefined" &&
  ...
  var MM_editRedirectUrl = "publdelok.asp";
...
rsAldea21PublUpd.Source = "SELECT datosID, tituloPublic, datosPublic, yearPublic, tipoPublic  FROM public, publicTipo  WHERE datosID = "+ rsAldea21PublUpd__MMColParam.replace(/'/g, "''") + " AND public.tipoPublicID = publicTipo.tipoPublicID";
...
<title>PPI Aldea 21 - Eliminar publicaci&oacute;n - 2 de 3</title>
<!-- #EndEditable --> 
      ...
      <table width="650" border="0" cellspacing="4" cellpadding="2">
        <tr> 
          <td> 
            ...
            <p align="center"><font face="Verdana, Arial, Helvetica, sans-serif" size="2"><b>UD. 
              EST&Aacute; A PUNTO DE ELIMINAR ESTE REGISTRO.<br>
              SI DESEA CONTINUAR, PRESIONE EL BOTON <font color="#FF0000">ELIMINAR 
              REGISTRO</font>. </b></font></p>
            <form action="<%=MM_editAction%>" method="POST" name="form1">
              <p>&nbsp; </p>
              <table width="100%" border="1">
                <tr> 
                  <td bgcolor="#FFCC99"><i><b><font size="1" face="Verdana, Arial, Helvetica, sans-serif">Tipo 
                    de publicacion</font></b></i></td>
                  <td> <font size="2" face="Verdana, Arial, Helvetica, sans-serif"><%=(rsAldea21PublUpd.Fields.Item("tipoPublic").Value)%> 
                    <input type="hidden" name="hiddenField">
                    </font></td>
                </tr>
                <tr> 
                  <td bgcolor="#FFCC99"><i><b><font size="1" face="Verdana, Arial, Helvetica, sans-serif">T&iacute;tulo 
                    de la publicaci&oacute;n</font></b></i></td>
                  <td><font size="2" face="Verdana, Arial, Helvetica, sans-serif"><%=(rsAldea21PublUpd.Fields.Item("tituloPublic").Value)%> </font></td>
                </tr>
                <tr> 
                  <td bgcolor="#FFCC99"><i><b><font size="1" face="Verdana, Arial, Helvetica, sans-serif">Datos 
                    de la publicaci&oacute;n</font></b></i></td>
                  <td><font size="2" face="Verdana, Arial, Helvetica, sans-serif"><%=(rsAldea21PublUpd.Fields.Item("datosPublic").Value)%> </font></td>
                </tr>
                <tr> 
                  <td bgcolor="#FFCC99"><i><b><font size="1" face="Verdana, Arial, Helvetica, sans-serif">A&ntilde;o 
                    de la publicaci&oacute;n</font></b></i></td>
                  <td><font size="2" face="Verdana, Arial, Helvetica, sans-serif"><%=(rsAldea21PublUpd.Fields.Item("yearPublic").Value)%> </font></td>
                </tr>
                <tr> 
                  <td colspan="2"> 
