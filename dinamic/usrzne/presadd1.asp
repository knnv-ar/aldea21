...
if (String(Request("MM_insert")) != "undefined") {
  ...
  var MM_fieldsStr = "datosPresCongr|value|yearPresCongr|value|integID|value";
  var MM_columnsStr = "datosPresCongr|',none,''|yearPresCongr|none,none,NULL|integID|none,none,NULL";
...
<title>PPI Aldea 21 - Ingresar presentaci&oacute;n - 1 de 2</title>
<!-- #EndEditable --> 
        ...
        <tr> 
          <td> 
            <p><font face="Verdana, Arial, Helvetica, sans-serif" size="2"><b>INGRESAR 
              PRESENTACI&Oacute;N - 1 de 2</b></font></p>
            <form method="POST" action="<%=MM_editAction%>" name="form1">
              <table align="center">
                <tr valign="baseline"> 
                  <td nowrap align="right" valign="middle" bgcolor="#FFCC99"> 
                    <div align="left"><i><b><font face="Verdana, Arial, Helvetica, sans-serif" size="1">Datos 
                      de la Presentaci&oacute;n:</font></b></i></div>
                  </td>
                  <td> <font face="Verdana, Arial, Helvetica, sans-serif" size="2"> 
                    <textarea name="datosPresCongr" cols="100" rows="4"></textarea>
                    </font></td>
                </tr>
                <tr valign="baseline"> 
                  <td nowrap align="right" valign="middle" bgcolor="#FFCC99"> 
                  ...
                  <td> <font face="Verdana, Arial, Helvetica, sans-serif" size="2"> 
                    <input type="text" name="yearPresCongr" value="" size="32">
