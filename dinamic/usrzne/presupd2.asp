...
if (String(Request("MM_update")) != "undefined" &&
  ...
  var MM_editTable  = "presCongr";
  var MM_editColumn = "presCongrID";
  var MM_recordId = "" + Request.Form("MM_recordId") + "";
  var MM_editRedirectUrl = "presupdok.asp";
  var MM_fieldsStr = "hiddenField|value|txt_datos|value|txt_year|value";
  var MM_columnsStr = "integID|none,none,NULL|datosPresCongr|',none,''|yearPresCongr|none,none,NULL";
...
%>
<%
var rsAldea21PresCongrUpd2__MMColParam = "1";
if(String(Request.QueryString("presCongrID")) != "undefined") { 
  rsAldea21PresCongrUpd2__MMColParam = String(Request.QueryString("presCongrID"));
}
%>
<%
var rsAldea21PresCongrUpd2 = Server.CreateObject("ADODB.Recordset");
rsAldea21PresCongrUpd2.ActiveConnection = MM_connaldea21_STRING;
rsAldea21PresCongrUpd2.Source = "SELECT * FROM presCongr WHERE presCongrID = "+ rsAldea21PresCongrUpd2__MMColParam.replace(/'/g, "''") + "";
rsAldea21PresCongrUpd2.CursorType = 0;
rsAldea21PresCongrUpd2.CursorLocation = 2;
rsAldea21PresCongrUpd2.LockType = 3;
rsAldea21PresCongrUpd2.Open();
var rsAldea21PresCongrUpd2_numRows = 0;
%>
<html>
<!-- #BeginTemplate "/Templates/model.dwt" --> 
<head>
<!-- #BeginEditable "doctitle" --> 
<title>PPI Aldea 21 - Actualizar presentaci&oacute;n - 2 de 3</title>
<!-- #EndEditable --> 
        ...
        <tr> 
          <td> 
            <p><font face="Verdana, Arial, Helvetica, sans-serif" size="2"><b>ACTUALIZAR 
              PRESENTACI&Oacute;N - 2 de 3</b></font></p>
            ...
            <form action="<%=MM_editAction%>" method="POST" name="form1">
              <table width="100%" border="1">
                <tr> 
                  <td bgcolor="#FFCC99"><font face="Verdana, Arial, Helvetica, sans-serif" size="2">Datos 
                    de la presentaci&oacute;n 
                    <input type="hidden" name="hiddenField" value="<%=(rsAldea21PresCongrUpd2.Fields.Item("integID").Value)%>">
                    </font></td>
                  <td> <font face="Verdana, Arial, Helvetica, sans-serif" size="2"> 
                    <textarea name="txt_datos" cols="100" rows="4"><%=(rsAldea21PresCongrUpd2.Fields.Item("datosPresCongr").Value)%></textarea>
                    </font></td>
                </tr>
                <tr> 
                  <td bgcolor="#FFCC99"><font face="Verdana, Arial, Helvetica, sans-serif" size="2">A&ntilde;o 
                    de la presentaci&oacute;n</font></td>
                  <td> <font face="Verdana, Arial, Helvetica, sans-serif" size="2"> 
                    <input value="<%=(rsAldea21PresCongrUpd2.Fields.Item("yearPresCongr").Value)%>" type="text" name="txt_year">
                    </font></td>
                </tr>
                <tr> 
                  <td colspan="2"> 
              ...
              <input type="hidden" name="MM_recordId" value="<%= rsAldea21PresCongrUpd2.Fields.Item("presCongrID").Value %>">
            </form>
          </td>
        </tr>
      </table>
