...
if (String(Request("MM_delete")) != "undefined" &&
  ...
  var MM_editRedirectUrl = "presdelok.asp";
...
if(String(Request.QueryString("presCongrID")) != "undefined") { 
  rsAldea21PublUpd__MMColParam = String(Request.QueryString("presCongrID"));
}
%>
<%
var rsAldea21PublUpd = Server.CreateObject("ADODB.Recordset");
rsAldea21PublUpd.ActiveConnection = MM_connaldea21_STRING;
rsAldea21PublUpd.Source = "SELECT *  FROM presCongr  WHERE presCongrID = "+ rsAldea21PublUpd__MMColParam.replace(/'/g, "''") + "";
...
<title>PPI Aldea 21 - Eliminar presentaci&oacute;n - 2 de 3</title>
<!-- #EndEditable --> 
        ...
        <tr> 
          <td> 
            ...
            <form action="<%=MM_editAction%>" method="POST" name="form1">
              ...
              <table width="100%" border="1">
                <tr> 
                  <td bgcolor="#FFCC99"><i><b><font face="Verdana, Arial, Helvetica, sans-serif" size="1">Datos 
                    de la presentaci&oacute;n</font></b></i></td>
                  <td> <font face="Verdana, Arial, Helvetica, sans-serif" size="2"><%=(rsAldea21PublUpd.Fields.Item("datosPresCongr").Value)%> </font></td>
                </tr>
                <tr> 
                  <td bgcolor="#FFCC99"><i><b><font face="Verdana, Arial, Helvetica, sans-serif" size="1">A&ntilde;o 
                    de la presentaci&oacute;n</font></b></i></td>
                  <td><font face="Verdana, Arial, Helvetica, sans-serif" size="2"><%=(rsAldea21PublUpd.Fields.Item("yearPresCongr").Value)%> </font></td>
                </tr>
                <tr> 
                  <td colspan="2"> 
              ...
              <input type="hidden" name="MM_recordId" value="<%= rsAldea21PublUpd.Fields.Item("presCongrID").Value %>">
            </form>
          </td>
        </tr>
      </table>
