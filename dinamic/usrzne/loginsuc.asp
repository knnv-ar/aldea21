<%@LANGUAGE="VBSCRIPT"%>
<%
If Request.Cookies("cLogin") = "" Then
...
<table width="650" border="0" cellspacing="0" cellpadding="0">
  <tr> 
    <td valign="top"><!-- #BeginEditable "contenido" --> 
      <SCRIPT LANGUAGE="JavaScript">  
// Spd This is added to the template in order to allow behaviours</SCRIPT>
      <table width="650" border="0" cellspacing="4" cellpadding="2">
        <tr> 
          <td> 
            <p><font face="Verdana, Arial, Helvetica, sans-serif" size="3">Bienvenido 
              <b><%= Request.Cookies("cIntegname") %></b> al &Aacute;rea de actualizaci&oacute;n de datos 
              de Aldea 21<br>
              </font><font face="Verdana, Arial, Helvetica, sans-serif" size="2"> 
              </font></p>
            <p><font face="Verdana, Arial, Helvetica, sans-serif" size="2"><a href="logout.asp">Salir 
              del &Aacute;rea de actualizaci&oacute;n de datos</a></font></p>
            <table width="100%" border="1">
              <tr> 
                <td bgcolor="#FFCC99"><font face="Verdana, Arial, Helvetica, sans-serif" size="2"><b>Curr&iacute;culum 
                  Vitae</b></font></td>
              </tr>
              <tr> 
                <td><font face="Verdana, Arial, Helvetica, sans-serif" size="2"><a href="cvupd.asp">Actualizar</a></font></td>
              </tr>
              <tr> 
                <td bgcolor="#FFCC99"><font face="Verdana, Arial, Helvetica, sans-serif" size="2"><b>Publicaciones</b></font></td>
              </tr>
              <tr> 
                <td><font face="Verdana, Arial, Helvetica, sans-serif" size="2"><a href="publadd.asp">Agregar</a></font></td>
              </tr>
              <tr> 
                <td><font face="Verdana, Arial, Helvetica, sans-serif" size="2"><a href="publupd1.asp">Actualizar</a></font></td>
              </tr>
              <tr> 
                <td><font face="Verdana, Arial, Helvetica, sans-serif" size="2"><a href="publdel1.asp">Eliminar</a></font></td>
              </tr>
              <tr> 
                <td bgcolor="#FFCC99"><font face="Verdana, Arial, Helvetica, sans-serif" size="2"><b>Presentaciones 
                  a Congresos y otros</b></font></td>
              </tr>
              <tr> 
                <td><font face="Verdana, Arial, Helvetica, sans-serif" size="2"><a href="presadd1.asp">Agregar</a></font></td>
              </tr>
              <tr> 
                <td><font face="Verdana, Arial, Helvetica, sans-serif" size="2"><a href="presupd1.asp">Actualizar</a></font></td>
              </tr>
              <tr> 
                <td><font face="Verdana, Arial, Helvetica, sans-serif" size="2"><a href="presdel1.asp">Eliminar</a></font></td>
              </tr>
            </table>
            <p>&nbsp;</p>
          </td>
