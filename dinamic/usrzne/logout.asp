<%@LANGUAGE="VBSCRIPT"%>
<%
Response.Cookies("cLogin").Expires = Date() -1
%>
<html>
<!-- #BeginTemplate "/Templates/model.dwt" --> 
<head>
<!-- #BeginEditable "doctitle" --> 
<title>PPI Aldea 21 - Salida del sistema</title>
<!-- #EndEditable --> 
  ...
  <tr> 
    <td valign="top"><!-- #BeginEditable "contenido" --> 
      <table width="650" border="0" cellspacing="4" cellpadding="2">
        <tr> 
          <td> 
            <p align="center"><font size="3" face="Arial, Helvetica, sans-serif"><b>Ud. 
              ha salido del &aacute;rea de Actualizaci&oacute;n de datos</b></font></p>
            <p>&nbsp;</p>
            <p><font face="Arial, Helvetica, sans-serif"><a href="login.asp">Volver 
              a ingresar</a><br>
              <a href="http://www.unq.edu.ar/aldea21/dinamic/index.asp">Volver 
