...
<title>PPI Aldea 21 - Eliminar publicaci&oacute;n - 1 de 3</title>
<!-- #EndEditable --> 
        ...
        <tr> 
          <td> 
            ...
            <p><font face="Verdana, Arial, Helvetica, sans-serif" size="2"><i>Seleccione 
              la publicaci&oacute;n que quiere eliminar</i></font></p>
            ...
            <table width="100%" border="1">
              ...
              <tr> 
                ...
                <td><font face="Verdana, Arial, Helvetica, sans-serif" size="2"><b><a href="publdel2.asp?<%= MM_keepNone + ((MM_keepNone!="")?"&":"") + "datosID=" + rsAldea21PublAct1.Fields.Item("datosID").Value %>"><%=(rsAldea21PublAct1.Fields.Item("tituloPublic").Value)%></a></b></font></td>
