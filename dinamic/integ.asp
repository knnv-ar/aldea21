...
<%
var rsAldea21Cv__MMColParam = "1";
if(String(Request.QueryString("id")) != "undefined") { 
  rsAldea21Cv__MMColParam = String(Request.QueryString("id"));
}
%>
<%
var rsAldea21Cv = Server.CreateObject("ADODB.Recordset");
rsAldea21Cv.ActiveConnection = MM_connaldea21_STRING;
rsAldea21Cv.Source = "SELECT * FROM dataCv WHERE integID = "+ rsAldea21Cv__MMColParam.replace(/'/g, "''") + "";
rsAldea21Cv.CursorType = 0;
rsAldea21Cv.CursorLocation = 2;
rsAldea21Cv.LockType = 3;
rsAldea21Cv.Open();
var rsAldea21Cv_numRows = 0;
%>
<%
var rsAldea21Integ__MMColParam = "1";
if(String(Request.QueryString("id")) != "undefined") { 
  rsAldea21Integ__MMColParam = String(Request.QueryString("id"));
}
%>
<%
var rsAldea21Integ = Server.CreateObject("ADODB.Recordset");
rsAldea21Integ.ActiveConnection = MM_connaldea21_STRING;
rsAldea21Integ.Source = "SELECT integID, integName FROM integ WHERE integID = "+ rsAldea21Integ__MMColParam.replace(/'/g, "''") + "";
rsAldea21Integ.CursorType = 0;
rsAldea21Integ.CursorLocation = 2;
rsAldea21Integ.LockType = 3;
rsAldea21Integ.Open();
var rsAldea21Integ_numRows = 0;
%>
<html>
  ...
  <tr> 
    <td valign="top"><!-- #BeginEditable "contenido" --> 
      <table width="100%" border="0" cellspacing="4" cellpadding="2">
        <tr> 
          <td> 
            <p><font face="Verdana, Arial, Helvetica, sans-serif" size="2"><img src="fotos/<%=(rsAldea21Cv.Fields.Item("fotoCv").Value)%>"></font></p>
            <p>&nbsp;</p>
            <p><font face="Verdana, Arial, Helvetica, sans-serif" size="2"><b><%=(rsAldea21Integ.Fields.Item("integName").Value)%></b></font></p>
            <p><font face="Verdana, Arial, Helvetica, sans-serif" size="2"><%=(rsAldea21Cv.Fields.Item("emailCv").Value)%></font></p>
            <p>&nbsp;</p>
            <p><font face="Verdana, Arial, Helvetica, sans-serif" size="2"><b><i>Datos 
              personales y formaci&oacute;n:</i></b><br>
              <%=(rsAldea21Cv.Fields.Item("datosPersCv").Value)%> </font></p>
            <p><font face="Verdana, Arial, Helvetica, sans-serif" size="2"><b><i>Posici&oacute;n 
              actual:</i></b><br>
              <%=(rsAldea21Cv.Fields.Item("posicActCv").Value)%> </font></p>
            <p><font face="Verdana, Arial, Helvetica, sans-serif" size="2"><b><i>L&iacute;nea 
              de investigaci&oacute;n, subsidios:</i></b><br>
              <%=(rsAldea21Cv.Fields.Item("lineaInvSubCv").Value)%> </font></p>
            <p><font face="Verdana, Arial, Helvetica, sans-serif" size="2"><b><i>Actividad 
              docente, conferencias, cooperaci&oacute;n, redes cient&iacute;ficas:</i></b><br>
              <%=(rsAldea21Cv.Fields.Item("activDocCv").Value)%> </font></p>
            <p><font face="Verdana, Arial, Helvetica, sans-serif" size="2"><b><i>Formaci&oacute;n 
              de recursos humanos:</i></b><br>
              <%=(rsAldea21Cv.Fields.Item("formRHCv").Value)%> </font></p>
            <p><font face="Verdana, Arial, Helvetica, sans-serif" size="2"><b><i>&Uacute;ltimas 
              publicaciones relevantes:</i></b><br>
              <%=(rsAldea21Cv.Fields.Item("publicRelevCv").Value)%> </font></p>
            <p><font face="Verdana, Arial, Helvetica, sans-serif" size="2"><b><i>Transferencia: 
              desarrollo tecnol&oacute;gico, servicios y consultor&iacute;as recientes:</i></b><br>
              <%=(rsAldea21Cv.Fields.Item("transCv").Value)%> </font></p>
            <p>&nbsp;</p>
          </td>
        </tr>
      </table>
