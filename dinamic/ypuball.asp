...
rsAldea21PublTipo.Source = "SELECT integName, tituloPublic, datosPublic, yearPublic, tipoPublic  FROM public, integ, publicTipo  WHERE public.tipoPublicID = publicTipo.tipoPublicID AND integ.integID = public.integID ORDER BY yearPublic DESC";
  ...
  <tr> 
    <td valign="top"><!-- #BeginEditable "contenido" --> 
      <table width="650" border="0" cellspacing="4" cellpadding="2">
        <tr> 
          <td> 
            <p><font face="Verdana, Arial, Helvetica, sans-serif" size="2"><b>PUBLICACIONES 
              ORDENADAS POR A&Ntilde;O</b></font></p>
