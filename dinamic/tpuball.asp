...
rsAldea21PublTipo.Source = "SELECT integName, tituloPublic, datosPublic, yearPublic, tipoPublic  FROM public, integ, publicTipo  WHERE public.tipoPublicID = publicTipo.tipoPublicID AND integ.integID = public.integID  ORDER BY public.tipoPublicID";
