...
rsAldea21Congr.Source = "SELECT integName, yearPresCongr, datosPresCongr  FROM presCongr, integ  WHERE integ.integID = presCongr.integID  ORDER BY integName";
        ...
        <tr> 
          <td> 
            ...
            <table width="100%" border="1">
              <tr bgcolor="#FFCC99"> 
                <td> 
                  <div align="center"><i><font face="Verdana, Arial, Helvetica, sans-serif" size="2">A&ntilde;o</font></i></div>
                </td>
                <td> 
                  <div align="center"><i><font face="Verdana, Arial, Helvetica, sans-serif" size="2">Integrante</font></i></div>
                </td>
                <td> 
                  <div align="center"><i><font face="Verdana, Arial, Helvetica, sans-serif" size="2">Detalle</font></i></div>
                </td>
              </tr>
