...
<%
var rsAldea21PublTipo__MMColParam = "1";
if(String(Request.Form("pum_ptip")) != "undefined") { 
  rsAldea21PublTipo__MMColParam = String(Request.Form("pum_ptip"));
}
%>
<%
var rsAldea21PublTipo = Server.CreateObject("ADODB.Recordset");
rsAldea21PublTipo.ActiveConnection = MM_connaldea21_STRING;
rsAldea21PublTipo.Source = "SELECT DISTINCT integName, tituloPublic, datosPublic, yearPublic, tipoPublic  FROM public, integ, publicTipo  WHERE public.tipoPublicID = "+ rsAldea21PublTipo__MMColParam.replace(/'/g, "''") + " AND public.tipoPublicID = publicTipo.tipoPublicID AND integ.integID = public.integID";
rsAldea21PublTipo.CursorType = 0;
rsAldea21PublTipo.CursorLocation = 2;
rsAldea21PublTipo.LockType = 3;
rsAldea21PublTipo.Open();
var rsAldea21PublTipo_numRows = 0;
%>
<%
var Repeat1__numRows = -1;
var Repeat1__index = 0;
rsAldea21PublTipo_numRows += Repeat1__numRows;
%>
<%
// *** Recordset Stats, Move To Record, and Go To Record: declare stats variables

// set the record count
var rsAldea21PublTipo_total = rsAldea21PublTipo.RecordCount;

// set the number of rows displayed on this page
if (rsAldea21PublTipo_numRows < 0) {            // if repeat region set to all records
  rsAldea21PublTipo_numRows = rsAldea21PublTipo_total;
} else if (rsAldea21PublTipo_numRows == 0) {    // if no repeat regions
  rsAldea21PublTipo_numRows = 1;
}

// set the first and last displayed record
var rsAldea21PublTipo_first = 1;
var rsAldea21PublTipo_last  = rsAldea21PublTipo_first + rsAldea21PublTipo_numRows - 1;

// if we have the correct record count, check the other stats
if (rsAldea21PublTipo_total != -1) {
  rsAldea21PublTipo_numRows = Math.min(rsAldea21PublTipo_numRows, rsAldea21PublTipo_total);
  rsAldea21PublTipo_first   = Math.min(rsAldea21PublTipo_first, rsAldea21PublTipo_total);
  rsAldea21PublTipo_last    = Math.min(rsAldea21PublTipo_last, rsAldea21PublTipo_total);
}
%>
<%
...
if (rsAldea21PublTipo_total == -1) {
  ...
  for (rsAldea21PublTipo_total=0; !rsAldea21PublTipo.EOF; rsAldea21PublTipo.MoveNext()) {
    rsAldea21PublTipo_total++;
  }

  // reset the cursor to the beginning
  if (rsAldea21PublTipo.CursorType > 0) {
    if (!rsAldea21PublTipo.BOF) rsAldea21PublTipo.MoveFirst();
  } else {
    rsAldea21PublTipo.Requery();
  }

  // set the number of rows displayed on this page
  if (rsAldea21PublTipo_numRows < 0 || rsAldea21PublTipo_numRows > rsAldea21PublTipo_total) {
    rsAldea21PublTipo_numRows = rsAldea21PublTipo_total;
  }

  // set the first and last displayed record
  rsAldea21PublTipo_last  = Math.min(rsAldea21PublTipo_first + rsAldea21PublTipo_numRows - 1, rsAldea21PublTipo_total);
  rsAldea21PublTipo_first = Math.min(rsAldea21PublTipo_first, rsAldea21PublTipo_total);
}
%>
<html>
...
<title>P&aacute;gina Principal del Programa Prioritario de Investigaci&oacute;n 
Aldea 21</title>
<!-- #EndEditable --> 
  ...
  <tr> 
    <td valign="top"><!-- #BeginEditable "contenido" --> 
      <table width="650" border="0" cellspacing="4" cellpadding="2">
        <tr> 
          <td> 
            <p><font face="Verdana, Arial, Helvetica, sans-serif" size="2"><b>PUBLICACIONES</b></font></p>
            <p><font face="Verdana, Arial, Helvetica, sans-serif" size="2">Total 
              de publicaciones encontradas: <b><%=(rsAldea21PublTipo_total)%></b> </font></p>
            <table width="100%" border="1">
              <tr bgcolor="#FFCC99"> 
                <td> 
                  <div align="center"><b><font size="1"><i><font face="Verdana, Arial, Helvetica, sans-serif">A&ntilde;o</font></i></font></b></div>
                </td>
                <td> 
                  <div align="center"><b><font size="1"><i><font face="Verdana, Arial, Helvetica, sans-serif">Autor</font></i></font></b></div>
                </td>
                <td> 
                  <div align="center"><b><font size="1"><i><font face="Verdana, Arial, Helvetica, sans-serif">Tipo 
                    de Publicaci&oacute;n</font></i></font></b></div>
                </td>
                <td> 
                  <div align="center"><b><font size="1"><i><font face="Verdana, Arial, Helvetica, sans-serif">T&iacute;tulo</font></i></font></b></div>
                </td>
                <td> 
                  <div align="center"><b><font size="1"><i><font face="Verdana, Arial, Helvetica, sans-serif">Detalle</font></i></font></b></div>
                </td>
                <td> 
                  <div align="center"><b><font size="1"><i><font face="Verdana, Arial, Helvetica, sans-serif">Diponibilidad 
                    en linea</font></i></font></b></div>
                </td>
              </tr>
              <% while ((Repeat1__numRows-- != 0) && (!rsAldea21PublTipo.EOF)) { %>
              <tr> 
                <td><font face="Verdana, Arial, Helvetica, sans-serif" size="2"><%=(rsAldea21PublTipo.Fields.Item("yearPublic").Value)%></font></td>
                <td><font face="Verdana, Arial, Helvetica, sans-serif" size="2"><%=(rsAldea21PublTipo.Fields.Item("integName").Value)%></font></td>
                <td><font face="Verdana, Arial, Helvetica, sans-serif" size="2"><%=(rsAldea21PublTipo.Fields.Item("tipoPublic").Value)%></font></td>
                <td><font face="Verdana, Arial, Helvetica, sans-serif" size="2"><b><%=(rsAldea21PublTipo.Fields.Item("tituloPublic").Value)%></b></font></td>
                <td><font face="Verdana, Arial, Helvetica, sans-serif" size="2"><%=(rsAldea21PublTipo.Fields.Item("datosPublic").Value)%></font></td>
                <td>&nbsp;</td>
              </tr>
              <%
  Repeat1__index++;
  rsAldea21PublTipo.MoveNext();
}
%>
            </table>
          </td>
