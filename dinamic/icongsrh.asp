...
rsAldea21PresCongrInteg.Source = "SELECT integName,  presCongr.integID  FROM integ, presCongr  WHERE integ.integID = presCongr.integID  GROUP BY integName, presCongr.integID  ORDER BY integName";
      ...
      <table width="650" border="0" cellspacing="4" cellpadding="2">
        <tr> 
          <td> 
            ...
            <form name="frm_pci" method="post" action="icongrst.asp">
              <table width="100%" border="1">
                <tr> 
                  <td bgcolor="#FFCC99"><font face="Verdana, Arial, Helvetica, sans-serif" size="2"><b><i><font size="1">B&uacute;squeda 
                    por Integrante</font></i></b></font></td>
                </tr>
                <tr> 
                  <td> <font face="Verdana, Arial, Helvetica, sans-serif" size="2"> 
                    <select name="pum_pci">
                      <%
while (!rsAldea21PresCongrInteg.EOF)
{
%>
                      <option value="<%=(rsAldea21PresCongrInteg.Fields.Item("integID").Value)%>" ><%=(rsAldea21PresCongrInteg.Fields.Item("integName").Value)%></option>
                      <%
