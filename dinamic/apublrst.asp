...
<%
var rsAldea21PublTipo__MMColParam = "4";
if(String(Request.Form("pum_aut")) != "undefined") { 
  rsAldea21PublTipo__MMColParam = String(Request.Form("pum_aut"));
}
%>
<%
var rsAldea21PublTipo = Server.CreateObject("ADODB.Recordset");
rsAldea21PublTipo.ActiveConnection = MM_connaldea21_STRING;
rsAldea21PublTipo.Source = "SELECT integName, tituloPublic, datosPublic, yearPublic, tipoPublic  FROM public, integ, publicTipo  WHERE public.integID = "+ rsAldea21PublTipo__MMColParam.replace(/'/g, "''") + " AND public.tipoPublicID = publicTipo.tipoPublicID AND integ.integID = public.integID";
        ...
        <tr> 
          <td> 
            ...
            <table width="100%" border="1">
              <tr bgcolor="#FFCC99"> 
                <td> 
                  <div align="center"><font size="1"><b><i><font face="Verdana, Arial, Helvetica, sans-serif">A&ntilde;o</font></i></b></font></div>
                </td>
                <td> 
                  <div align="center"><font size="1"><b><i><font face="Verdana, Arial, Helvetica, sans-serif">Autor</font></i></b></font></div>
                </td>
                <td> 
                  <div align="center"><font size="1"><b><i><font face="Verdana, Arial, Helvetica, sans-serif">Tipo 
                    de Publicaci&oacute;n</font></i></b></font></div>
                </td>
                <td> 
                  <div align="center"><font size="1"><b><i><font face="Verdana, Arial, Helvetica, sans-serif">T&iacute;tulo</font></i></b></font></div>
                </td>
                <td> 
                  <div align="center"><font size="1"><b><i><font face="Verdana, Arial, Helvetica, sans-serif">Detalle</font></i></b></font></div>
                </td>
                <td> 
                  <div align="center"><font size="1"><b><i><font face="Verdana, Arial, Helvetica, sans-serif">Diponibilidad 
                    en linea</font></i></b></font></div>
                </td>
              </tr>
