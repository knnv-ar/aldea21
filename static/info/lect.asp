...
<title>PPI Aldea 21 - Lecturas recomendadas</title>
<!-- #EndEditable --> 
...
<script language="JavaScript1.2" src="../../dinamic/fw_menu.js"></script>
...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
  ...
  <tr> 
    <!-- Shim row, height 1. -->
    <td><img src="../../dinamic/images/spacer.gif" width="80" height="1" border="0"></td>
    <td><img src="../../dinamic/images/spacer.gif" width="116" height="1" border="0"></td>
    <td><img src="../../dinamic/images/spacer.gif" width="75" height="1" border="0"></td>
    <td><img src="../../dinamic/images/spacer.gif" width="90" height="1" border="0"></td>
    <td><img src="../../dinamic/images/spacer.gif" width="97" height="1" border="0"></td>
    <td><img src="../../dinamic/images/spacer.gif" width="63" height="1" border="0"></td>
    <td><img src="../../dinamic/images/spacer.gif" width="68" height="1" border="0"></td>
    <td><img src="../../dinamic/images/spacer.gif" width="128" height="1" border="0"></td>
    <td><img src="../../dinamic/images/spacer.gif" width="1" height="1" border="0"></td>
  </tr>
  <tr> 
    <!-- row 1 -->
    <td colspan="8"><a href="http://www.unq.edu.ar/aldea21/dinamic/index.asp"><img name="indexasp_r1_c1" src="../../dinamic/images/index.asp_r1_c1.gif" width="717" height="60" border="0" alt="P&aacute;gina Principal del PPI Aldea 21"></a></td>
    <td><img src="../../dinamic/images/spacer.gif" width="1" height="60" border="0"></td>
  </tr>
  <tr> 
    <!-- row 2 -->
    <td width="80"><a href="http://www.unq.edu.ar/aldea21/dinamic/index.asp"><img name="indexasp_r2_c1" src="../../dinamic/images/index.asp_r2_c1.gif" width="80" height="18" border="0"></a></td>
    <td width="116"><a href="#" onMouseOut="FW_startTimeout();"  onMouseOver="window.FW_showMenu(window.fw_menu_0,81,78);" ><img name="indexasp_r2_c2" src="../../dinamic/images/index.asp_r2_c2.gif" width="116" height="18" border="0"></a></td>
    <td width="75"><a href="#" onMouseOut="FW_startTimeout();"  onMouseOver="window.FW_showMenu(window.fw_menu_1,196,78);" ><img name="indexasp_r2_c3" src="../../dinamic/images/index.asp_r2_c3.gif" width="75" height="18" border="0"></a></td>
    <td width="90"><a href="#" onMouseOut="FW_startTimeout();"  onMouseOver="window.FW_showMenu(window.fw_menu_2,271,78);" ><img name="indexasp_r2_c4" src="../../dinamic/images/index.asp_r2_c4.gif" width="90" height="18" border="0"></a></td>
    <td width="97"><a href="#" onMouseOut="FW_startTimeout();"  onMouseOver="window.FW_showMenu(window.fw_menu_3,361,78);" ><img name="indexasp_r2_c5" src="../../dinamic/images/index.asp_r2_c5.gif" width="97" height="18" border="0"></a></td>
    <td width="63"><a href="#" onMouseOut="FW_startTimeout();"  onMouseOver="window.FW_showMenu(window.fw_menu_4,458,78);" ><img name="indexasp_r2_c6" src="../../dinamic/images/index.asp_r2_c6.gif" width="63" height="18" border="0"></a></td>
    <td width="68"><a href="#" onMouseOut="FW_startTimeout();"  onMouseOver="window.FW_showMenu(window.fw_menu_5,521,78);" ><img name="indexasp_r2_c7" src="../../dinamic/images/index.asp_r2_c7.gif" width="68" height="18" border="0"></a></td>
    <td background="../../dinamic/images/a21_loop.gif"> 
      <div align="right"><img src="../../dinamic/images/a21_tail.gif" width="12" height="18"></div>
    </td>
    <td><img src="../../dinamic/images/spacer.gif" width="1" height="18" border="0"></td>
  </tr>
...
<table width="650" border="0" cellspacing="0" cellpadding="0">
  <tr> 
    <td valign="top"><!-- #BeginEditable "contenido" -->
      <table width="100%" border="0" cellspacing="4" cellpadding="2">
        <tr>
          <td>
            <p><b><font face="Verdana, Arial, Helvetica, sans-serif" size="2">LECTURAS 
              RECOMENDADAS</font></b></p>
            <p><font face="Verdana, Arial, Helvetica, sans-serif" size="2"><img src="images/arrow.gif" width="8" height="13"><a href="http://enredando.com/cas/cgi-bin/enredantes/plantilla.pl?ident=59">&quot;La 
              ciudad de las redes: Una prospectiv@ en.red.ada&quot; por Ester 
              Schiavo.</a></font></p>
            <p><font face="Verdana, Arial, Helvetica, sans-serif" size="2"><img src="images/arrow.gif" width="8" height="13"></font><font size="2"><a href="http://www.unq.edu.ar/aldea21/static/cccf/inicio/index.htm"><font face="Verdana, Arial, Helvetica, sans-serif">&quot;Ciudad, 
              cine y ciencia ficci&oacute;n&quot; por Sol Quiroga.</font></a></font></p>
                </td>
        </tr>
      </table>
      <!-- #EndEditable --> </td>
  ...
  <tr> 
    <td> 
      <div align="center"> 
        <p>&nbsp;</p>
        <p><b><font face="Verdana, Arial, Helvetica, sans-serif" size="1"><img src="../../dinamic/images/newunq.gif" width="117" height="43"><br>
          <br>
